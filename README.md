# Shri Choudeshwari Medical & General Store — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-shri-choudeshwari-medical-store/
- **Repo:** `shreekantha3/sindagi-shri-choudeshwari-medical-store` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-shri-choudeshwari-medical-store/'` for GitHub Pages project-site hosting.
